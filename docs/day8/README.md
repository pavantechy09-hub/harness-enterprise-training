# Day 8 — AIOps + AIDA + SRM

## Service Added / Updated
SLOs configured, error budgets tracked

## Pipeline File
`.harness/pipelines/day8-aiops-srm.yaml`
...
See the Day 8 tab in the course UI for:
