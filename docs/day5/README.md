# Day 5 — Canary and Blue-Green Strategies

## Service Added / Updated
Canary: payments-service, Blue-Green: accounts-service

## Pipeline File
`.harness/pipelines/day5-canary-payments.yaml`
...
See the Day 5 tab in the course UI for:
